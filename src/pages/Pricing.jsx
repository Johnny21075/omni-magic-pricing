                    ...
                    {[
                      ...
                      },
                      {
                        ...
                        pricing: (() => {
                          ...
                          const isVip = cat === 'corporate_vip_gala';
                          const isGala = cat === 'corporate_gala';
                          const cuFrom = isVip ? 'from $4,000' : isGala ? 'from $2,000' : 'from $1,250';
                          const stFrom = isVip ? 'from $3,500' : isGala ? 'from $1,750' : 'from $900';
                          const buFrom = isVip ? 'from $4,500' : isGala ? 'from $2,250' : 'from $1,750';
                          return [
                            { label: 'Close‑Up Only', from: cuFrom },
                            { label: 'Stage Only', from: stFrom },
                            { label: 'Close‑Up + Stage', from: buFrom, popular: true },
